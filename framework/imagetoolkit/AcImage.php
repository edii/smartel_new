 ...
 * @since 2013-03-12
 */
namespace framework\imagetoolkit;
...
//namespace framework\imagetoolkit\AcImage;

use framework\imagetoolkit\geometry\Rectangle as Rectangle;
use framework\imagetoolkit\geometry\Size as Size; 
use framework\imagetoolkit\geometry\Point as Point;
use framework\imagetoolkit\AcColor as AcColor;
use framework\imagetoolkit\AcImageJPG as AcImageJPG;
use framework\imagetoolkit\AcImageGIF as AcImageGIF;
use framework\imagetoolkit\AcImagePNG as AcImagePNG;

use framework\imagetoolkit\geometry\IllegalArgumentExceptions as IllegalArgumentExceptions;
use framework\imagetoolkit\geometry\FileNotFoundException as FileNotFoundException;
use framework\imagetoolkit\geometry\InvalidFileException as InvalidFileException;
use framework\imagetoolkit\geometry\GDnotInstalledException as GDnotInstalledException;
use framework\imagetoolkit\geometry\UnsupportedFormatException as UnsupportedFormatException;
use framework\imagetoolkit\geometry\FileAlreadyExistsException as FileAlreadyExistsException;
use framework\imagetoolkit\geometry\FileNotSaveException as FileNotSaveException;
use framework\imagetoolkit\geometry\IllegalArgumentException as IllegalArgumentException;
...
class AcImage extends \CApplicationComponent
{
	const PNG = 'image/png';
